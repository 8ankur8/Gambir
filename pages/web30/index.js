...
import Diamonds from "../world/diamonds/Diamonds"
        ...
        <Block factor={1} offset={0}>
          ...
          <Block factor={1.0}>
            <Html className="bottom-left" style={{ color: "white" }} position={[-canvasWidth / 2, -canvasHeight / 2, 0]}>
              the year 2022.{mobile ? <br /> : " "}The world had arrived.
            </Html>
          </Block>
        </Block>
...
function Index() {
    ...
    return (
        ...
        <Canvas linear dpr={[1, 2]} orthographic camera={{ zoom: state.zoom, position: [0, 0, 500] }}>
          <Suspense fallback={<Html center className={styles.loading} children="Loading..." />}>
            <Content />
            <Diamonds />
            <Startup />
          </Suspense>
