  ...
  paragraphs: [
    {
      ...
      image: "/web30/one.png",
      aspect: 1.51,
      text: "High competency web3 company to help businesses migrate to the future of commerce and technology. We believe in the power of web3"
    },
    {
      offset: 2,
      factor: 2.0,
      header: "Gamification",
      image: "/web30/three.jpg",
      aspect: 1.5,
      text:
        "The Wallets, blockchain, and digital technology — for creating a truly democratic and transparent world."
    },
    {
      offset: 3,
      factor: 2.25,
    ...
    },
    {
      ...
      aspect: 0.665,
      text:
        "Weve found that the people whose EEG doesnt show any alpha-wave activity when they’re relaxed aren’t likely to respond significantly to the substance. That means that, for about fifteen percent of the population, we have to find other approaches to liberation."
    },
    {
      offset: 5,
      factor: 1.75,
      header: "Governance",
      image: "/web30/four.jpg",
      aspect: 1.55,
      text:
    ...
    { offset: 7, factor: 1.05, header: "The Factory", image: "/web30/building.jpeg", aspect: 1.77, text: "Education and enlightenment." }
  ],
  stripes: [
